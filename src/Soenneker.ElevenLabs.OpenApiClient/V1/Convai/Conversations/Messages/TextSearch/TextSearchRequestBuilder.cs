...
namespace Soenneker.ElevenLabs.OpenApiClient.V1.Convai.Conversations.Messages.TextSearch
{
    ...
    public partial class TextSearchRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TextSearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/convai/conversations/messages/text-search?text_query={text_query}{&agent_id*,branch_id*,call_duration_max_secs*,call_duration_min_secs*,call_start_after_unix*,call_start_before_unix*,call_successful*,conversation_initiation_source*,conversation_product_type*,cursor*,data_collection_params*,evaluation_params*,exclude_statuses*,has_feedback_comment*,main_languages*,page_size*,rating_max*,rating_min*,sort_by*,summary_mode*,termination_reasons*,text_only*,tool_names*,tool_names_errored*,tool_names_successful*,topic_ids*,user_id*,version_id*,visited_agent_branch_ids*,visited_agent_ids*}", rawUrl)
        {
        }
        /// <summary>
