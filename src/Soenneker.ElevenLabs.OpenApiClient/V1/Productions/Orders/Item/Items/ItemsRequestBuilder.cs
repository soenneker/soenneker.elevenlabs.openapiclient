...
using Soenneker.ElevenLabs.OpenApiClient.V1.Productions.Orders.Item.Items.Item;
...
namespace Soenneker.ElevenLabs.OpenApiClient.V1.Productions.Orders.Item.Items
{
    ...
    public partial class ItemsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ElevenLabs.OpenApiClient.V1.Productions.Orders.Item.Items.ItemsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ElevenLabs.OpenApiClient.Models.UpsertOrderItemResponse"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.ElevenLabs.OpenApiClient.Models.BodyUpsertOrderItemV1ProductionsOrdersOrderIdItemsPost body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.ElevenLabs.OpenApiClient.Models.BodyUpsertOrderItemV1ProductionsOrdersOrderIdItemsPost body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ElevenLabs.OpenApiClient.V1.Productions.Orders.Item.Items.ItemsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.ElevenLabs.OpenApiClient.V1.Productions.Orders.Item.Items.ItemsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.ElevenLabs.OpenApiClient.V1.Productions.Orders.Item.Items.ItemsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
