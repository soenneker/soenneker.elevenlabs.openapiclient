...
namespace Soenneker.ElevenLabs.OpenApiClient.Models
{
    ...
    public partial class Update_phone_number_route_200 : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        public static global::Soenneker.ElevenLabs.OpenApiClient.Models.Update_phone_number_route_200 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("provider")?.GetStringValue();
            var result = new global::Soenneker.ElevenLabs.OpenApiClient.Models.Update_phone_number_route_200();
