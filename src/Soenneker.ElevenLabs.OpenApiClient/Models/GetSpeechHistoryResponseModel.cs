...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "last_history_item_id", n => { LastHistoryItemId = n.GetStringValue(); } },
                { "scanned_until", n => { ScannedUntil = n.GetIntValue(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteStringValue("last_history_item_id", LastHistoryItemId);
            writer.WriteIntValue("scanned_until", ScannedUntil);
