...
namespace Soenneker.ElevenLabs.OpenApiClient.Models
{
    ...
    public partial class OAuth2JWTResponse : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>JWT signing algorithm</summary>
        public global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_algorithm? Algorithm { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_auth_type? AuthType { get; set; }
        /// <summary>Token expiration time in seconds</summary>
        public int? ExpirationSeconds { get; set; }
        /// <summary>Additional custom claims to include in the JWT</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_extra_params? ExtraParams { get; set; }
#nullable restore
#else
        public global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_extra_params ExtraParams { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_token_response_field? TokenResponseField { get; set; }
...
#nullable restore
        ...
        public OAuth2JWTResponse()
        {
            ...
            Algorithm = global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_algorithm.HS256;
            AuthType = global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_auth_type.Oauth2_jwt;
            TokenResponseField = global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_token_response_field.Access_token;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "algorithm", n => { Algorithm = n.GetEnumValue<global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_algorithm>(); } },
                { "audience", n => { Audience = n.GetStringValue(); } },
                { "auth_type", n => { AuthType = n.GetEnumValue<global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_auth_type>(); } },
                ...
                { "token_response_field", n => { TokenResponseField = n.GetEnumValue<global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_token_response_field>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_algorithm>("algorithm", Algorithm);
            writer.WriteStringValue("audience", Audience);
            writer.WriteEnumValue<global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_auth_type>("auth_type", AuthType);
            ...
            writer.WriteEnumValue<global::Soenneker.ElevenLabs.OpenApiClient.Models.OAuth2JWTResponse_token_response_field>("token_response_field", TokenResponseField);
