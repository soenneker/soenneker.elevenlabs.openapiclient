...
namespace Soenneker.ElevenLabs.OpenApiClient.Models
{
    ...
    public partial class ConversationChargingCommonModelTtsUsage : IAdditionalDataHolder, IParsable
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ElevenLabs.OpenApiClient.Models.ConversationChargingCommonModelTtsUsage"/> and sets the default values.
        /// </summary>
        public ConversationChargingCommonModelTtsUsage()
        {
            AdditionalData = new Dictionary<string, object>();
            TotalAudioOutputSeconds = 0.0;
            TotalCharacters = 0;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ElevenLabs.OpenApiClient.Models.ConversationChargingCommonModelTtsUsage"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.ElevenLabs.OpenApiClient.Models.ConversationChargingCommonModelTtsUsage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.ElevenLabs.OpenApiClient.Models.ConversationChargingCommonModelTtsUsage();
        }
        /// <summary>
