...
namespace Soenneker.ElevenLabs.OpenApiClient.Models
{
    ...
    public partial class ListAuthConnectionsResponse : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The auth_connections property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse.ListAuthConnectionsResponse_auth_connections>? AuthConnections { get; set; }
#nullable restore
#else
        public List<global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse.ListAuthConnectionsResponse_auth_connections> AuthConnections { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "auth_connections", n => { AuthConnections = n.GetCollectionOfObjectValues<global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse.ListAuthConnectionsResponse_auth_connections>(global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse.ListAuthConnectionsResponse_auth_connections.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse.ListAuthConnectionsResponse_auth_connections>("auth_connections", AuthConnections);
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ListAuthConnectionsResponse_auth_connections : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse.ListAuthConnectionsResponse_auth_connections"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse.ListAuthConnectionsResponse_auth_connections CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("auth_type")?.GetStringValue();
                var result = new global::Soenneker.ElevenLabs.OpenApiClient.Models.ListAuthConnectionsResponse.ListAuthConnectionsResponse_auth_connections();
                if("api_integration_oauth2_auth_code".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
                ...
                else if("api_integration_oauth2_custom_app".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
                ...
                else if("basic_auth".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
                    result.BasicAuthResponse = new global::Soenneker.ElevenLabs.OpenApiClient.Models.BasicAuthResponse();
                }
                else if("bearer_auth".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
                    result.BearerAuthResponse = new global::Soenneker.ElevenLabs.OpenApiClient.Models.BearerAuthResponse();
                }
                else if("custom_header_auth".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
