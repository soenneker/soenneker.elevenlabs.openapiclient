...
namespace Soenneker.ElevenLabs.OpenApiClient.Models
{
    ...
    public partial class ResponseGetPhoneNumberV1ConvaiPhoneNumbersPhoneNumberIdGet : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        public static global::Soenneker.ElevenLabs.OpenApiClient.Models.ResponseGetPhoneNumberV1ConvaiPhoneNumbersPhoneNumberIdGet CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("provider")?.GetStringValue();
            var result = new global::Soenneker.ElevenLabs.OpenApiClient.Models.ResponseGetPhoneNumberV1ConvaiPhoneNumbersPhoneNumberIdGet();
